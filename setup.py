...
setup(
    name=NAME,
    version=VERSION,
    description="Vektis.AGB.WebAPI.Raadplegen (test-agb-api.vektis.nl/) v2",
    author="OpenAPI Generator community",
    author_email="team@openapitools.org",
    url="",
    keywords=["OpenAPI", "OpenAPI-Generator", "Vektis.AGB.WebAPI.Raadplegen (test-agb-api.vektis.nl/) v2"],
    ...
    De raadpleegdienst biedt de mogelijkheid voor diverse bevragingen op AGB. De informatie die beschikbaar is, kan gebruikt worden voor het aanvragen van AGB-codes met de aanvraagdienst.
    """,  # noqa: E501
    package_data={"vektis_api": ["py.typed"]},
)
