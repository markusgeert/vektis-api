...
class VektisAGBWebAPIRaadplegenDataContractsV2OndernemingAdres(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Aanvang", "Einde", "Huisnummer", "HuisnummerToevoeging", "Plaats", "Postcode", "Straat"]
