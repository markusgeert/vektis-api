...
class VektisAGBWebAPIRaadplegenDataContractsTestModel(BaseModel):
    """
    
    """ # noqa: E501
    number: Optional[StrictInt] = Field(default=None, alias="Number")
    multiplied_by_self: Optional[StrictInt] = Field(default=None, alias="MultipliedBySelf")
    __properties: ClassVar[List[str]] = ["Number", "MultipliedBySelf"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "MultipliedBySelf": obj.get("MultipliedBySelf")
        })
        return _obj
