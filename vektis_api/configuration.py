...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://test-agb-api.vektis.nl" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("vektis_api")
    ...
    def get_host_settings(self) -> List[HostSetting]:
        ...
        """
        return [{
            'url': "https://test-agb-api.vektis.nl",
