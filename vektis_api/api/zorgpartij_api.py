...
class ZorgpartijApi:
    ...
    @validate_call
    def zorgpartij_zorgpartij_mutaties(
        self,
        vanaf: StrictStr,
        ...
        _param = self._zorgpartij_zorgpartij_mutaties_serialize(
            vanaf=vanaf,
    ...
    @validate_call
    def zorgpartij_zorgpartij_mutaties_with_http_info(
        self,
        vanaf: StrictStr,
        authorization: Annotated[StrictStr, Field(description="access token")],
        _request_timeout: Union[
    ...
    @validate_call
    def zorgpartij_zorgpartij_mutaties_without_preload_content(
        self,
        vanaf: StrictStr,
        authorization: Annotated[StrictStr, Field(description="access token")],
        _request_timeout: Union[
    ...
    def _zorgpartij_zorgpartij_mutaties_serialize(
        self,
        vanaf,
        authorization,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/zorgpartijen/mutaties/{vanaf}',
    ...
    @validate_call
    def zorgpartij_zorgpartij_mutaties_0(
        self,
        zorgsoort: StrictStr,
        vanaf: StrictStr,
        authorization: Annotated[StrictStr, Field(description="access token")],
        ...
        _param = self._zorgpartij_zorgpartij_mutaties_0_serialize(
            zorgsoort=zorgsoort,
            vanaf=vanaf,
            authorization=authorization,
            _request_auth=_request_auth,
    ...
    @validate_call
    def zorgpartij_zorgpartij_mutaties_0_with_http_info(
        self,
        zorgsoort: StrictStr,
        vanaf: StrictStr,
        authorization: Annotated[StrictStr, Field(description="access token")],
    ...
    @validate_call
    def zorgpartij_zorgpartij_mutaties_0_without_preload_content(
        self,
        zorgsoort: StrictStr,
        vanaf: StrictStr,
        authorization: Annotated[StrictStr, Field(description="access token")],
    ...
    def _zorgpartij_zorgpartij_mutaties_0_serialize(
        self,
        zorgsoort,
        vanaf,
        authorization,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/zorgpartijen/mutaties/{zorgsoort}/{vanaf}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def zorgpartij_zorgpartijen(
        self,
        paginanummer: StrictInt,
        aantal: StrictInt,
        authorization: Annotated[StrictStr, Field(description="access token")],
        _request_timeout: Union[
            None,
        ...
        :param paginanummer: (required)
        :type paginanummer: int
        :param aantal: (required)
        :type aantal: int
        :param authorization: access token (required)
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._zorgpartij_zorgpartijen_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "VektisAGBWebAPIRaadplegenDataContractsV2ZorgpartijActieveZorgpartijen",
            '400': "str",
            '401': "str",
            '500': "str",
        }
    ...
    @validate_call
    def zorgpartij_zorgpartijen_with_http_info(
        self,
        paginanummer: StrictInt,
        aantal: StrictInt,
        authorization: Annotated[StrictStr, Field(description="access token")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VektisAGBWebAPIRaadplegenDataContractsV2ZorgpartijActieveZorgpartijen]:
        """Raadplegen van actieve zorgpartijen.
    ...
    @validate_call
    def zorgpartij_zorgpartijen_without_preload_content(
        self,
        paginanummer: StrictInt,
        aantal: StrictInt,
        authorization: Annotated[StrictStr, Field(description="access token")],
    ...
    def _zorgpartij_zorgpartijen_serialize(
        self,
        paginanummer,
        aantal,
        authorization,
        ...
        # process the path parameters
        # process the query parameters
        if paginanummer is not None:
            
            _query_params.append(('paginanummer', paginanummer))
            
        if aantal is not None:
            
            _query_params.append(('aantal', aantal))
    ...
    def zorgpartij_zorgpartijen_0(
        ...
        _param = self._zorgpartij_zorgpartijen_0_serialize(
            zorgsoort=zorgsoort,
            paginanummer=paginanummer,
            aantal=aantal,
            authorization=authorization,
    ...
    @validate_call
    def zorgpartij_zorgpartijen_0_with_http_info(
        self,
        zorgsoort: StrictStr,
        paginanummer: StrictInt,
        aantal: StrictInt,
    ...
    @validate_call
    def zorgpartij_zorgpartijen_0_without_preload_content(
        self,
        zorgsoort: StrictStr,
        paginanummer: StrictInt,
        aantal: StrictInt,
    ...
    def _zorgpartij_zorgpartijen_0_serialize(
        self,
        zorgsoort,
        paginanummer,
        aantal,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/zorgpartijen/{zorgsoort}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
