...
from vektis_api.api_response import ApiResponse, T as ApiResponseT
import vektis_api.models
from vektis_api import rest
from vektis_api.exceptions import (ApiValueError, ApiException,
    ...
    def deserialize(self, response_text: str, response_type: str,
        ...
        if content_type is None:
            ...
            if response_text == "":
                ...
                data = json.loads(response_text)
        elif re.match(r'^text\/[a-z.+-]+\s*(;|$)', content_type,
                      re.IGNORECASE):
            data = response_text
        else:
            raise ApiException(
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(vektis_api.models, klass)
