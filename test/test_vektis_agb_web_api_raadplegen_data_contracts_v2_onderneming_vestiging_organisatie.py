...
class TestVektisAGBWebAPIRaadplegenDataContractsV2OndernemingVestigingOrganisatie(unittest.TestCase):
    """VektisAGBWebAPIRaadplegenDataContractsV2OndernemingVestigingOrganisatie unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VektisAGBWebAPIRaadplegenDataContractsV2OndernemingVestigingOrganisatie:
        """Test VektisAGBWebAPIRaadplegenDataContractsV2OndernemingVestigingOrganisatie
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VektisAGBWebAPIRaadplegenDataContractsV2OndernemingVestigingOrganisatie`
        """
        model = VektisAGBWebAPIRaadplegenDataContractsV2OndernemingVestigingOrganisatie()
        if include_optional:
            return VektisAGBWebAPIRaadplegenDataContractsV2OndernemingVestigingOrganisatie(
    ...
    def testVektisAGBWebAPIRaadplegenDataContractsV2OndernemingVestigingOrganisatie(self):
        """Test VektisAGBWebAPIRaadplegenDataContractsV2OndernemingVestigingOrganisatie"""
