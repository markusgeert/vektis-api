...
class TestVektisAGBWebAPIRaadplegenDataContractsV2OndernemingOnderneming(unittest.TestCase):
    """VektisAGBWebAPIRaadplegenDataContractsV2OndernemingOnderneming unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VektisAGBWebAPIRaadplegenDataContractsV2OndernemingOnderneming:
        """Test VektisAGBWebAPIRaadplegenDataContractsV2OndernemingOnderneming
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VektisAGBWebAPIRaadplegenDataContractsV2OndernemingOnderneming`
        """
        model = VektisAGBWebAPIRaadplegenDataContractsV2OndernemingOnderneming()
        if include_optional:
            return VektisAGBWebAPIRaadplegenDataContractsV2OndernemingOnderneming(
    ...
    def testVektisAGBWebAPIRaadplegenDataContractsV2OndernemingOnderneming(self):
        """Test VektisAGBWebAPIRaadplegenDataContractsV2OndernemingOnderneming"""
