...
class TestVektisAGBWebAPIRaadplegenDataContractsV2RelatieRelatie(unittest.TestCase):
    """VektisAGBWebAPIRaadplegenDataContractsV2RelatieRelatie unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VektisAGBWebAPIRaadplegenDataContractsV2RelatieRelatie:
        """Test VektisAGBWebAPIRaadplegenDataContractsV2RelatieRelatie
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VektisAGBWebAPIRaadplegenDataContractsV2RelatieRelatie`
        """
        model = VektisAGBWebAPIRaadplegenDataContractsV2RelatieRelatie()
        if include_optional:
            return VektisAGBWebAPIRaadplegenDataContractsV2RelatieRelatie(
    ...
    def testVektisAGBWebAPIRaadplegenDataContractsV2RelatieRelatie(self):
        """Test VektisAGBWebAPIRaadplegenDataContractsV2RelatieRelatie"""
